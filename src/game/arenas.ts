...
export const ARENAS: Arena[] = [
  {
    ...
    playerHp: 220, gunDamage: 20, gunName: "Pistol", fireRate: 350, carCount: 4,
  },
  {
    ...
    playerHp: 260, gunDamage: 26, gunName: "SMG", fireRate: 180, carCount: 5,
  },
  {
    ...
    playerHp: 300, gunDamage: 32, gunName: "Rifle", fireRate: 220, carCount: 7,
  },
  {
    ...
    playerHp: 340, gunDamage: 40, gunName: "Shotgun", fireRate: 500, carCount: 8,
  },
  {
    ...
    playerHp: 400, gunDamage: 50, gunName: "Heavy MG", fireRate: 120, carCount: 9,
  },
];

// Static building footprints — shared with collision logic.
// Each building is 6x6 (half-extent 3) centered at (x, z).
export const BUILDINGS: { x: number; z: number; halfX: number; halfZ: number }[] = [];
for (const x of [-22, 22]) {
  for (const z of [-18, -6, 6, 18]) {
    BUILDINGS.push({ x, z, halfX: 3, halfZ: 3 });
  }
}
